...
<main>
				...
				<li class="swiper-slide">
					<div href="player.php" class="swiper-item">
						...
						<div class="btn-flex">
							...
							<a class="btn btn-danger" href="javascript:void(0);" onclick="return check()">DELETE</a>
						</div>
						@else
						<!-- 装飾用 -->
						<div class="btn-flex">
	...
	<!-- $list->id が空でなければ表示するでないと値がないですとエラーでる -->
	@if(!empty($list->id))
	<!-- 削除確認ポップアップ -->
	<div id="overflow">
		<div class="conf">
			<div class="conf_inner">
				...
				<div class="btns">
					<form action="/post/{{ $list->id }}/delete" onclick="return next()">
